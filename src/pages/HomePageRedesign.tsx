          ...
          <div className="grid lg:grid-cols-3 gap-6 mb-8">
            ...
            <div className="space-y-6">
              ...
              {settings.flashSaleEnabled ? (
                ...
                <div className="relative overflow-hidden rounded-2xl shadow-xl bg-gradient-to-br from-slate-700 via-slate-800 to-slate-900 p-8 text-white group hover:shadow-2xl transition-all block border border-slate-600">
                  <div className="relative z-10 space-y-4 flex flex-col items-center justify-center min-h-[280px]">
                    <div className="text-6xl animate-bounce">🔔</div>
                    <div className="text-center space-y-2">
                      <p className="text-sm font-semibold text-slate-300 uppercase tracking-widest">Coming Soon</p>
                      <h3 className="text-4xl font-black bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">
                        Flash Sale
                      </h3>
                      <p className="text-xl font-bold text-slate-100 mt-2">Stay Tuned</p>
                      <p className="text-sm text-slate-400 mt-3 max-w-xs">Amazing deals are being prepared! Get ready for incredible savings.</p>
                    </div>
                    <div className="mt-4 flex items-center gap-2 text-sm font-semibold text-blue-400 animate-pulse">
